...
GENERATED_DIR="ecoscope-workflows-weapon-use-workflow"
REGISTRY_BIN="${GENERATED_DIR}/.pixi/envs/default/bin/wt-registry"
REGISTRY_JSON="/tmp/wt_registry_apn_weapon_use.json"
...
out = Path('$GENERATED_DIR') / 'ecoscope_workflows_weapon_use_workflow' / 'rjsf.json'
